...
from models.users.entries.glycaemia.food import Food as GlycaemiaModel
from schemas.users.entries.glycaemia.food import Food as GlycaemiaSchema


class GlycaemiaFood(Resource):
